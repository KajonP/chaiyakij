    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 align-self-end">
                <h2>จัดการข้อมูลขนส่งรายวันแยกเป็นร้านค้า</h2>
            </div>
            <div class="col-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">จัดการข้อมูลขนส่งรายวันแยกเป็นร้านค้า</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    columns: [
        ...
        className: "text-center",
        data: function(a) {
            let url_order_detail = window.location.origin +'/master-data/itemmerchant/'+ a.merchant_id+'/'+a.date_send;
