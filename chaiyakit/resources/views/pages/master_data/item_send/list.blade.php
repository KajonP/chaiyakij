    ...
    <div class="container-fluid">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="{{ url('master-data/itemsend') }}">จัดการข้อมูลขนส่งรายวัน</a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">{{$datefrom}}</li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="row">
            <div class="col-12 col-md-12 align-self-end">
                <h2>จัดการข้อมูลขนส่งรายวัน : วันที่จัดส่ง {{$datefrom}}</h2>
            </div>
        </div>
        <hr>
        {{-- <div class="row">
                    ...
                    <table class="table table-striped dt-responsive nowrap" style="width:100%" id="table">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td><span class="item_qty">{{ number_format($item->qty_sum) }}</span></td>
                                {{-- <td>{{ $item->product_weight_text }}</td> --}}
                            </tr>
                            @endforeach
