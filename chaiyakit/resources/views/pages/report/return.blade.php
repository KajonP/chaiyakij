                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="{{ route('report_return') }}">เมนูรายงาน</a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">การคืนสินค้า</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    serverSide: true,
    ajax: {
        url: "{{ route('api:report:return:list') }}",
        method: "GET",
        data: function(d) {
            d._token = "{{ csrf_token() }}";
            d.search = $("#search").val();
    ...
    columns: [
        ...
        { className: "", data: "order_delivery_number" },
